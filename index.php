...
?>
   ...
   <section id="teams" style="padding-top:5rem; background: #eaeaea;">

      <div class="row">

         <div class="twelve columns collapsed">

            <h1 class="text-center text-light ">Our Teams</h1>

            <!-- portfolio-wrapper -->
            <div id="portfolio-wrapper" class="bgrid-quarters s-bgrid-thirds cf">
               <?php 
                  $p_qry = $conn->query("SELECT * FROM teams order by company_name asc");
          ...
          <?php 
              $p_qry = $conn->query("SELECT * FROM teams ");
              while($row = $p_qry->fetch_assoc()):
            ?>
